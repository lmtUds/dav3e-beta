...
classdef Model < Gui.Modules.GuiModule
    ...
    methods
        ...
        function [panel,menu] = makeLayout(obj)
            ...
            defsPanel = uix.Panel('Parent',leftLayout, 'Title','model', 'Padding',5);
%             tablePanel = uix.Panel('Parent',leftLayout, 'Title','feature ranges', 'Padding',5);
...
%             obj.tabGroup = uitabgroup(obj.detailsLayout);
            ...
            obj.parametersDropdownPanel = uix.Panel('Parent',obj.detailsLayout, 'Title','parameters', 'Padding',2);
