...
classdef BFCReconstructor < FeatureExtraction.extractHelpers.ReconstructorInterface
    %BFCRECONSTRUCTER Summary of this class goes here
    ...
    methods
        function this = BFCReconstructor(ind, sens, target)
            if nargin > 0
                this.ind = ~ind;
                this.sensor = sens;
        ...
        function res = getResiduals(this, cycNum)
            ...
            data(this.ind) = complex(0);
            
            %reconstruct signal
            recData = ifft(data(1:length(this.originalCycle)),'symmetric');
