...
function info = divideByOneCycle()
    info.type = DataProcessingBlockTypes.RawDataPreprocessing;
    info.caption = 'divide by one cycle';
    info.shortCaption = mfilename;
    info.description = '';
    info.parameters = [...
        Parameter('shortCaption','cycleNumber', 'value',int32(1)),... 
...
function params = train(data,params)
    params.cycleData = data(params.cycleNumber,:);
end